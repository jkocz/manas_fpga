...
pkt_period = 131072 #how often to send another packet in FPGA clocks (200MHz)
...
#fpgfile = 'manas_tge.fpg'
fpgfile = 'manas_tge2_2025-12-10_1559.fpg'
fpga=[]
...
#        print 'There is no cable plugged into port1. Please plug a cable between ports 0 and 1 to continue demo. Exiting.'
 ...
 #   print 'done'
    ...
    sys.stdout.flush()
    fpga.write_int('dest_ip',ip_base+3)
